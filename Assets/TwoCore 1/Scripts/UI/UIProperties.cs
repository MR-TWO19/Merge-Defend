...
namespace TwoCore
{
    ...
    [Serializable]
    public struct ItemRandomId
    {
        public int id;

        public ItemRandomId(int id)
        {
            this.id = id;
        }

        public static implicit operator int(ItemRandomId value) => value.id;
        public static implicit operator ItemRandomId(int id) => new ItemRandomId(id);
    ...
    [Serializable]
    public struct RewardedAdId
    {
        public int groupId;
        public int id;

        public RewardedAdId(int id)
        {
            groupId = -1;
            this.id = id;
        }

        public static implicit operator int(RewardedAdId value) => value.id;
        public static implicit operator RewardedAdId(int id) => new RewardedAdId(id);
    ...
    [Serializable]
    public struct RewardedAdGroupId
    {
        public int groupId;

        public RewardedAdGroupId(int id)
        {
            this.groupId = id;
        }

        public static implicit operator int(RewardedAdGroupId value) => value.groupId;
        public static implicit operator RewardedAdGroupId(int id) => new RewardedAdGroupId(id);
