...
namespace Hawky.Sound
{
    public class SoundManager : MonoSingleton<SoundManager>
    {
        ...
        private void Awake()
        {
            var allClip = Resources.LoadAll<AudioClip>("Sounds");
            ...
            var data = SaveDataManager.Ins.GetData<SettingData>();

            sound = data.sound ? 1 : 0;
            music = data.music ? 1 : 0;
        }

        public void PlayBackground(string soundId, float volume = 1)
        {
